                    ...
                    <div className='bg-white shadow px-16 py-4 flex justify-between items-center'>
                        <div className='slect flex '>
                            <select className='border border-tl rounded-tl border-bl rounded-bl py-4 px-2'>
                                <option> <FormattedMessage id="Rent" /></option>
                            </select>
                            <input className='py-4 px-12 border' placeholder='Los Angeles' />
                            <i className='fa fa-search bg-[#5e81f4] py-4 px-4 text-white border border-tr rounded-tr border-br rounded-br '></i>
                        </div>
                        <div className=''>
                            <p><span><i className='fa fa-phone mr-2'></i></span>+ 1 (800) 657 8976 </p>
                        </div>
                    </div>
                    <div className='grid grid-cols-2 gap-4 mt-6'>
                        <div className='column1'>
                            <p className='text-[12px]'><FormattedMessage id='stays.430' /></p>
                            <p className='text-[26px] font-bold'><FormattedMessage id='stays.los' /></p>
                            <div className='flex justify-between mt-6'>
                                <button className='rounded-full px-6 py-2 border text-[12px] font-bold bg-[#ededfe]'><FormattedMessage id='Fee.Cancellation' /></button>
                                <button className='rounded-full px-6 py-2 border text-[12px] '><FormattedMessage id='price' /></button>
                                <button className='rounded-full px-6 py-2 border text-[12px] '><FormattedMessage id='Instant.Book' /></button>
                            ...
                            <div className='card mt-6'>
                                <div class="mt-4 border px-2 py-2 shadow rounded-xl flex items-start">
                                    ...
                                    <div class="py-2 px-4  text-[14px]">
                                        ...
                                        <FormattedMessage id='furnished.apartment' /></h5>
                                        ...
                                        <FormattedMessage id='guests.2' /> |  <FormattedMessage id='bedroom.1' /> | <FormattedMessage id='bathroom.2'/> </h5>
                                       
                                        <h5 class=" tracking-tight mt-6 ">
                                        <FormattedMessage id='entire.studio' />  </h5>
