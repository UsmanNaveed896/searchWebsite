      ...
      <div className="px-8 py-4">
        ...
        <div className="grid grid-cols-3 gap-4 pb-10">
          <div className="col-span-2 relative">
            <div className="relative">
              <img src={Car1} alt="Car1" className="w-full h-[600px]" />
          ...
          <div className="flex flex-col  ">
            <img src={Car2} alt="Car2" className="h-[200px] w-[350px]" />
            <img src={Car3} alt="Car3" className="h-[200px] w-[350px]" />
            <img src={Car4} alt="Car4" className="h-[200px] w-[350px]" />
          </div>
        </div>
        ...
        <div className="flex items-start inline-block">
          <div className="border border-black rounded-lg pb-8 flex">
            <div className="flex flex-col w-1/2">
              <p className="pt-4 pl-4 font-bold pb-4">
              ...
              <div className="flex items-center pl-4">
                ...
                <i className="fa fa-check text-[#1F5E7C]"></i>
                <p className="">
                  <FormattedMessage id="title.suspension" />
                </p>
              </div>
              <div className="flex items-center pl-4">
                <i className="fa fa-check text-[#1F5E7C]"></i>
                <p className=" pr-12">
                  <FormattedMessage id="title.exterior" />
                </p>
                <i className="fa fa-check text-[#1F5E7C]"></i>
                <p className="">
                  <FormattedMessage id="title.interior" />
                </p>
              </div>
        ...
        <div className="flex justify-between pt-2">
          <div className="w-2/6">
            <div className="flex justify-between">
              ...
              <p>
                <FormattedMessage id="title.sedan" />
              </p>
            </div>
          </div>
          <div className="w-2/6 mx-auto">
        ...
        <ul>
          ...
          <li className="inline-block">
            <span className="inline-block pr-8">ABS</span>
          </li>
          <li className="inline-block fa fa-headphones text-[#757575]"></li>
          <li className="inline-block">
            <span className="inline-block pl-4 pr-8">
              <FormattedMessage id="am.fm.radio" />
            </span>
          </li>
          <li className="inline-block fa fa-exclamation-triangle text-[#757575]"></li>
          <li className="inline-block">
            <span className="inline-block pl-4 pr-8">
              <FormattedMessage id="air.bags" />
            </span>
          </li>
        </ul>
        <ul>
