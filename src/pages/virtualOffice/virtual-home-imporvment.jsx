    ...
    >
           <VirtualOfficeheader locale={locale}/>
                ...
                <div className='bg-[#F1EEEE] px-2 py-2 mt-4 w-[95%] rounded-lg mb-10' style={{ boxShadow: shadow }}>
                    <div className='flex justify-center gap-32 items-center'>
                        ...
                        <div className='price  px-6'>
                            <p className='font-medium text-[#000000] text-[16] font-Poppins '><FormattedMessage id="name" /></p>
                            <div className='relative'>
                        ...
                        <div className='price  px-6'>
                            <p className='font-medium text-[#000000] text-[16] font-Poppins'> <FormattedMessage id='SPECIALTIES' /></p>
                            <select className='mt-1 px-2 py-2 w-48 bg-[#F1EEEE] text-[12px] font-Poppins font-medium  text-[#918C8C] border border-[#918C8C] rounded-md'>
                                <option> <FormattedMessage id="Any" /></option>
                            </select>
                        </div>
            ...
            <div className='flex items-center justify-between mt-8 mb-8 px-12 '>
                ...
                <h1 className='font-bold text-[20px] font-Poppins text-[#000000]'><FormattedMessage id="Location" />
                 </h1>
                <h1 className='font-bold text-[20px] font-Poppins text-[#000000]'><FormattedMessage id="client.review" /></h1>
            </div>
            <div className='px-6 mt-8 pb-16 '>
                <div className='flex px-4 py-4 justify-between rounded-lg' style={{ boxShadow: shadow }}>
                    <div className=' w-[372px]  flex gap-2 items-center rounded-lg px-2 py-2' style={{ boxShadow: shadow }}>
                        <img src={Img1} alt='company name' />
                        <div className=''>
                            <h2 className='text-[#1F5E7C] text-[16px] font-Poppins font-bold'><FormattedMessage id='Company.Name' /></h2>
                ...
                <p className='text mt-8 text-[#0C356A]'>
                    Whether you are looking for an interior designer, general contractor or an architect, our local directory of home
                    improvement experts in Ludowici GA connects you to <br></br> professionals who can help complete your project and provide home inspiration along the way.
                </p>
                <p className='text mt-8 text-[#0C356A]'>
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut 
                labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud <br></br> exercitation ullamco laboris nisi ut
                 aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu
                  fugiat nulla pariatur.<br></br> Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."
                </p>
            </div>
            </IntlProvider>
        </>
