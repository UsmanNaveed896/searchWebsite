                ...
                <div className='homepage relative'>
                    ...
                    <div className=' bg-cover h-screen pb-16' style={{ backgroundImage: `url(${Img})` }}>
                        <div className='flex justify-evenly'>
                            <div className='container max-w-[1000px] mt-32'>
                                <h1 className='font-bold text-[50px] leading-[60px] text-white'><FormattedMessage id="home.title1" />
                                    <br></br>
                                    <FormattedMessage id="home.title2" />
                                </h1>
                                <p className='mt-12 text-white text-[22px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.<br></br>
                                    Sed do  eiusmod tempor incididunt ut
                                    Ut enim <br></br> ad minim veniam.
                                </p>
                                <div className='bg-white px-6 py-4 mt-16'>
                                    <div className='flex justify-center gap-6 items-center'>
                                        <div className='ss border-r border-black px-6'>
                                            <div className='price  px-6'>
                                                <p className='font-bold '>  <FormattedMessage id="Location" /></p>
                                                <select className='mt-3 text-[#757575]'>
                                                    <option> <FormattedMessage id="city" /></option>
                                                </select>
                                            </div>
                                        </div>
                                        <div className='price border-r border-black px-6'>
                                            <p className='font-bold '> <FormattedMessage id="price" /></p>
                                            <p className='mt-3 text-[#757575]'>$10000 - $50000  <span><i class="fa fa-money text-[#757575] ml-8" aria-hidden="true"></i></span> </p>

                                        </div>
                                        <div className='price border-r border-black px-6'>
                                            <p className='font-bold '> <FormattedMessage id="type" /></p>
                                            <select className='mt-3 text-[#757575]'>
                                                <option><FormattedMessage id="property" /></option>
                                            </select>
                                        </div>
                                        <div className='px-6'>
                                ...
                                <div className='flex gap-4 mt-16'>
                                    <div className='rounded-full bg-white h-16 w-16 text-center'>
                                        <i class="fa fa-home text-[26px] mt-1.5" aria-hidden="true"></i>
                                        <p className='text-[12px] font-bold'>+500k</p>
                                    </div>
                                    <div className='rounded-full bg-white h-16 w-16 text-center'>
                                        <i class="fa fa-building text-[26px] mt-2" aria-hidden="true"></i>
                                        <p className='text-[12px] font-bold'>+200k</p>
                                    </div>
                                    <div className='rounded-full bg-white h-16 w-16 text-center'>
                                        <i class="fa fa-industry text-[26px] mt-2" aria-hidden="true"></i>
                    ...
                    <div className='flex justify-evenly'>
                        <div className='container max-w-[1000px] mt-16'>
                            <p className='font-bold text-[28px] text-[#1B8693] pb-2'> <FormattedMessage id="Featured Ad" /></p>
                                        ...
                                        <div className='relative'>
                                            <div className='absolute'>
                                                <div className='head  px-3 w-[100px] rounded-full bg-white border border-[#1E8E94] text-[#1E8E94] mt-1 ml-1'>
                                                    <h1 className='text-[12px] '> <FormattedMessage id="Limited-Time" /></h1>
                                                </div>
                                                <h1 className='font-semibold text-[14px] mt-1 ml-1'> <FormattedMessage id="Get-Special-Offer" /> <br></br><FormattedMessage id="up-to" />
                                                    <span className='text-[16px] font-bold font-semibold '>40 %</span> </h1>
                                                <h1 className='text-[12px] mt-6  font-semibold ml-1'><FormattedMessage id="All-washing-services-available" /></h1>
                                                <div className='absolute bottom-[-1.5rem] right-[-2rem]'>
                                                    <span className='bg-[#1F5E7C] px-2 py-1 rounded-xl text-white text-center font-bold text-[12px]'><FormattedMessage id="Claim" /></span>
                                                </div>
                                            </div>
                            ...
                            <div className='mt-16 rounded-xl py-4' >
                                <div className='flex justify-between  mb-3'>
                                    <p className='font-bold text-[12px]'> <FormattedMessage id="live" /></p>
                                    <p className='text-[#1B8693] text-[12px] font-semibold'> <FormattedMessage id="View-All" /></p>
                                </div>
                                ...
                                <div className=''>
                                    <p className='text-center font-semibold text-[13px]'> <FormattedMessage id="Your-Live-Streaming-Only-For-5-Minutes" /> </p>
                                    <div className="flex justify-center mt-4">
                                        <button
                            ...
                            <div>
                                <div className='flex justify-between items-center mt-16  mb-3'>
                                    <p className='font-bold text-[12px]'><FormattedMessage id="news" /></p>
                                    <p className='font-bold text-[28px] text-[#1B8693]'> <FormattedMessage id="News-For-You" /></p>
                                    <p className='text-[#1B8693] text-[12px] font-semibold'><FormattedMessage id="View-All" /></p>
                                </div>
                            </div>
                                ...
                                <div class="max-w-sm mt-4 rounded-xl"
                                    ...
                                    <div class="p-5 text-center bg-[#1f5e7c] text-white">
                                        ...
                                        <h5 class="mb-1 text-[16px] text-[#6c889b] font-bold tracking-tight">
                                            April 24 2024 - 5 min read</h5>
                                        <h5 class=" text-[16px] font-semibold tracking-tight ">
                                            sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</h5>
                                    </div>
                            ...
                            <div className=' text-center mt-16  mb-3'>
                                <p className='font-bold text-[28px] text-[#1B8693]'><FormattedMessage id="homes.for.you" /></p>
                                <p className=' font-semibold'><FormattedMessage id="dream.property.seller" />
                                </p>
                            </div>
                            ...
                            <p className='text-[#1B8693] text-center text-[15px] font-bold mt-4'><FormattedMessage id="more" /></p>


                            {/*Cars For You Card */}
                            <div className=' text-center mt-16  mb-3'>
                                <p className='font-bold text-[28px] text-[#1B8693]'><FormattedMessage id="cars.for.you" /></p>
                                <p className=' font-semibold'><FormattedMessage id="dream.car.seller" /></p>
                            </div>
                            <div className='flex gap-6 mt-16'>
                                <div class="max-w-sm mt-4 rounded-xl"
                                    style={{ boxShadow: shadow }} >
                    ...
                    <div className='about-search px-12 mb-12'>
                        <div className=' text-start mt-16 px-2  mb-3'>
                            <p className='font-bold text-[28px] text-[#1B8693]'><FormattedMessage id="about.search" /> </p>
                            <p className=''>"Lorem ipsum dolor sit amet, consectetur adipiscing elit,<br></br>
                                sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                Ut enim ad minim <br></br> veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea <br></br> commodo consequat. </p>
                        </div>
                    </div>
