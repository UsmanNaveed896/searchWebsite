                ...
                <div className=''>
                    <div className='px-8 py-4'>
                        <div className='list flex  items-center justify-between font-semibold text-[#1E1E1E]'>
                            <ul className='flex  items-center' style={{justifyContent: locale === 'fr' ? 'space-around' : '' ,gap:locale !== 'fr'? '4rem' : '' }}>
                                <li className='cursor-pointer hover:font-bold' >
                                    <div className="hs-dropdown relative inline-flex">
                                        ...
                                        <div
                                            className={`hs-dropdown-menu absolute top-[33px] z-[44] transition-[opacity,margin] duration ${isOpen ? 'opacity-100' : 'opacity-0 hidden'
                                ...
                                <li className='cursor-pointer hover:font-bold'><FormattedMessage id="Cars" /></li>
                                <li className='cursor-pointer hover:font-bold' onClick={() => navigate('/virtualoffice')}> <FormattedMessage id="Virtual-Office" /></li>
                            </ul>
                            <div>
                                <img className='cursor-pointer' onClick={() => navigate('/')} src={Img} alt='logo' />
                            </div>
                            <ul className='flex gap-8 items-center'>
                            <li className='cursor-pointer hover:font-bold'> <FormattedMessage id="Furniture" /></li>
                                <li className='cursor-pointer hover:font-bold'> <FormattedMessage id="Advertise" /> </li>
                                <li className='cursor-pointer hover:font-bold'> <FormattedMessage id="Help" /> </li>
                                <li className='cursor-pointer hover:font-bold'>
                                    <select
                                        value={locale}
